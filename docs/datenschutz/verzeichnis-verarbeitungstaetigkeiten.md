...
## 7. Verwaltungszugriff auf Chat-Leads
...
- [ ] Betreiber und Standort der PostgreSQL-Datenbank eintragen
- [ ] Verschlüsselung im Ruhezustand und Aufbewahrung der Backups dokumentieren
