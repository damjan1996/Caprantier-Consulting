        ...
        <div className="grid md:grid-cols-3 gap-6">
          {experience.map((item, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <div className="group p-8 rounded-2xl border border-white/10 bg-white/5 text-center h-full transition-all duration-500 hover:bg-white/10 hover:border-primary/30 hover:shadow-xl hover:shadow-primary/5 hover:-translate-y-2 cursor-default">
