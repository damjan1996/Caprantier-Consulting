        ...
        <div className="grid md:grid-cols-2 gap-6">
          {services.map((service, index) => (
            <FadeIn key={index} delay={index * 0.1}>
              <div className={`group relative p-8 md:p-10 rounded-3xl border border-border bg-white h-full transition-all duration-500 hover:bg-muted ${service.borderHover} hover:shadow-xl ${service.shadow} hover:-translate-y-1 cursor-default overflow-hidden`}>
